...
The source is configured for the provisional `0.20.0` release under these
coordinates:

- `at.bernhardberger.tvheadend:sdk-android:0.20.0`
- `at.bernhardberger.tvheadend:sdk-core:0.20.0`
- `at.bernhardberger.tvheadend:sdk-media3:0.20.0`
- `at.bernhardberger.tvheadend:sdk-playback:0.20.0`
- `at.bernhardberger.tvheadend:sdk-testing:0.20.0`

Source, local staging, and CI
do not establish that the configured `0.20.0` coordinates are publicly available;
...
version. Patch versions are reserved for backward-compatible fixes. The `0.20.0`
