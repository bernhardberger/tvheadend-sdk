...
- `at.bernhardberger.tvheadend:sdk-core:0.5.0`
- `at.bernhardberger.tvheadend:sdk-media3:0.5.0`
- `at.bernhardberger.tvheadend:sdk-playback:0.5.0`
- `at.bernhardberger.tvheadend:sdk-testing:0.5.0`

The `v0.4.0` tag marks the preceding release line. Source, local staging, and CI
do not establish that the configured `0.5.0` coordinates are publicly available;
...
configured `0.5.0` line is the next provisional minor after the tagged `0.4.0`
line and carries an intentional clean playback-outcome replacement without
legacy aliases, facades, overloads, or shims.
